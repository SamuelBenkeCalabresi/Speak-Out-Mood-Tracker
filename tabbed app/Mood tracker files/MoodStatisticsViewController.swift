//
//  MoodStatisticsViewController.swift
//  Speak Out!
//
...
class MoodStatisticsViewController: UIViewController {
    ...
    func viewControllerForSegment(_ index: Int) -> UIViewController {
        ...
        case 1:   return storyboard!.instantiateViewController(withIdentifier: "SuggestionViewController")
